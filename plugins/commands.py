...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "📢 Jᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ❤", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**Uɴᴋɪʟ Jᴏɪɴ Mʏ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ᴛᴏ ᴜsᴇ ᴛʜɪs Bᴏᴛ 🤦**",
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        await msg.edit('Iᴅɪᴏᴛ Fɪʟᴇ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ᴅᴀᴛᴀʙᴀsᴇ 😒')
    else:
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.message.edit('Uɴᴋɪʟ Sᴜᴄᴄᴇsғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ Aʟʟ Tʜᴇ Iɴᴅᴇxᴇᴅ Fɪʟᴇs 😐.')
...
async def settings(client, message):
    ...
    if chat_type == "private":
        ...
        if grpid is not None:
            ...
            await message.reply_text("Wᴛғ I'ᴍ ɴᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴀɴʏ ɢʀᴏᴜᴘs!", quote=True)
            return
    ...
    if settings is not None:
        ...
        await message.reply_text(
            text=f"<b>Cʜᴀɴɢᴇ Yᴏᴜʀ Sᴇᴛᴛɪɴɢs ғᴏʀ {title} As Yᴏᴜʀ Wɪsʜ ⚙</b>",
            reply_markup=reply_markup,
