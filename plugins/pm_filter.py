...
async def next_page(bot, query):
    ...
    if not search:
        await query.answer("Uɴᴋɪʟ Yᴏᴜ ᴀʀᴇ ᴜsɪɴɢ ᴏɴᴇ ᴏғ ᴍʏ ᴏʟᴅ ᴍᴇssᴀɢᴇs, ᴘʟᴇᴀsᴇ sᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇsᴛ ᴀɢᴀɪɴ 🙂.", show_alert=True)
        return
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('Tʜɪs Mᴏᴠɪᴇ Nᴏᴛ Fᴏᴜɴᴅ Iɴ DᴀᴛᴀBᴀsᴇ ♲︎ ᴛʏᴘᴇ #ʀᴇǫᴜᴇsᴛ ᴍᴏᴠɪᴇ/sᴇʀɪᴇs ɴᴀᴍᴇ & ʏᴇᴀʀ ᴀᴅᴍɪɴ ᴡɪʟʟ ᴀᴅᴅ ✆')
    ...
    if query.data == "close_data":
        ...
        if chat_type == "private":
            ...
            if (st.status == "creator") or (str(userid) in ADMINS):
                ...
                await query.answer("😕 Iᴅɪᴏᴛ Tʜᴀᴛ's ɴᴏᴛ ғᴏʀ ʏᴏᴜ!!", show_alert=True)
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Cʜᴇᴄᴋ Pᴇʀsᴏɴᴀʟ ᴍᴇssᴀɢᴇ sᴇɴᴛ ʙʏ: @Ott_MoviesBot,I ʜᴀᴠᴇ sᴇɴᴛ ғɪʟᴇs ɪɴ ᴘᴍ 🤩', show_alert=True)
        ...
        await query.answer("Rᴇғʀᴇsʜɪɴɢ ʙʏ Fᴇᴛᴄʜɪɴɢ DᴀᴛᴀBᴀsᴇ...")
        buttons = [[
            InlineKeyboardButton('👩‍🦯 Back', callback_data='help'),
            InlineKeyboardButton('♻️ Rᴇғʀᴇsʜ', callback_data='rfrsh')
        ]]
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"✅ ᴅᴜᴅᴇ Hᴇʀᴇ ɪs ᴡʜᴀᴛ ɪ ғᴏᴜɴᴅ ғᴏʀ ʏᴏᴜʀ ǫᴜᴇʀʏ 🥳 <b>{search}</b>"
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("✘ I ᴄᴏᴜʟᴅɴ'ᴛ ғɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ɪɴ ᴛʜᴀᴛ ɴᴀᴍᴇ Cʜᴇᴄᴋ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ ✔")
        await asyncio.sleep(8)
        await k.delete()
        return
