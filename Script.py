...
Mʏ Nᴀᴍᴇ ɪs <a href=https://t.me/{}>{}</a> \nɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ᴀɴᴅ sᴇʀɪᴇs ɪɴ ʜɪɢʜ ǫᴜᴀʟɪᴛʏ [HD] Jᴜsᴛ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ As Aᴅᴍɪɴ Tʜᴀᴛs Aʟʟ I Wɪʟʟ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs Tʜᴇʀᴇ⚡\nMᴀɪɴᴛᴀɪɴᴇD Bʏ : <a href=https://t.me/robo_glitch>༒Gʟɪᴛᴄʜ༒</a>"""
    HELP_TXT = """Oʏᴇ Dᴜᴅᴇ ⚡ {}
...
➣ /filter - <code>Aᴅᴅ ᴀ ғɪʟᴛᴇʀ ɪɴ ᴄʜᴀᴛ</code>
➣ /filters - <code>Lɪsᴛ ᴀʟʟ ᴛʜᴇ ғɪʟᴛᴇʀs ᴏғ ᴀ ᴄʜᴀᴛ</code>
➣ /del - <code>Dᴇʟᴇᴛᴇ ᴀ sᴘᴇᴄɪғɪᴄ ғɪʟᴛᴇʀ ɪɴ ᴀ ᴄʜᴀᴛ</code>
➣ /delall - <code>Dᴇʟᴇᴛᴇ ᴛʜᴇ ᴡʜᴏʟᴇ ғɪʟᴛᴇʀs ɪɴ ᴀ ᴄʜᴀᴛ (Cʜᴀᴛ Oᴡɴᴇʀ Oɴʟʏ ❗)</code>"""
    BUTTON_TXT = """Help: <b>🔘 ༒Buttons༒ 🔘</b>

➣ I Sᴜᴘᴘᴏʀᴛs ʙᴏᴛʜ ᴜʀʟ ᴀɴᴅ ᴀʟᴇʀᴛ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴs ✔

<b>📌 ༒NOTE༒:</b>
1. Tᴇʟᴇɢʀᴀᴍ ᴡɪʟʟ ɴᴏᴛ ❌ ᴀʟʟᴏᴡs ʏᴏᴜ ᴛᴏ sᴇɴᴅ ʙᴜᴛᴛᴏɴs ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ᴄᴏɴᴛᴇɴᴛ, sᴏ ᴄᴏɴᴛᴇɴᴛ ɪs ᴍᴀɴᴅᴀᴛᴏʀʏ.
2. I sᴜᴘᴘᴏʀᴛs ʙᴜᴛᴛᴏɴs ᴡɪᴛʜ ᴀɴʏ ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ ᴛʏᴘᴇ.
3. Bᴜᴛᴛᴏɴs sʜᴏᴜʟᴅ ʙᴇ ᴘʀᴏᴘᴇʀʟʏ ᴘᴀʀsᴇᴅ ᴀs ᴍᴀʀᴋᴅᴏᴡɴ ғᴏʀᴍᴀᴛ. 

<b>🔘 ༒URL buttons༒ 🔘:</b>
<code>[Button Text](buttonurl:https://t.me/robo_glitch)</code>
...
<b>📌 ༒NOTE༒:</b>
➣ Mᴀᴋᴇ ᴍᴇ ᴛʜᴇ ᴀᴅᴍɪɴ ᴏғ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ɪғ ɪᴛ's ᴘʀɪᴠᴀᴛᴇ.
➣ ᴍᴀᴋᴇ sᴜʀᴇ ᴛʜᴀᴛ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ᴅᴏᴇs ɴᴏᴛ ᴄᴏɴᴛᴀɪɴs ᴄᴀᴍʀɪᴘs ᴘᴏʀɴ ᴀɴᴅ ғᴀᴋᴇ ғɪʟᴇs☠︎︎ Oᴛʜᴇʀᴡɪsᴇ ʏᴏᴜ ᴡɪʟʟ ʙᴇ ᴘᴇʀᴍᴀɴᴇɴᴛʟʏ ʙᴀɴ 🚫 ʙʏ Aɴ Aᴅᴍɪɴ.
➣ Fᴏʀᴡᴀʀᴅ ᴛʜᴇ ʟᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴍᴇ ᴡɪᴛʜ ǫᴜᴏᴛᴇs.
...
2. Sᴇɴᴅ <code>/Cᴏɴɴᴇᴄᴛ</code>Fᴏʀ Cᴏɴɴᴇᴄᴛɪɴɢ Mᴇ ᴛᴏ Yᴏᴜʀ PM ∞

<b>༒Commands and Usage༒:</b>
➣ /connect  - <code>Cᴏɴɴᴇᴄᴛ ᴀ ᴘᴀʀᴛɪᴄᴜʟᴀʀ ᴄʜᴀᴛ ᴛᴏ ʏᴏᴜʀ PM</code>
➣ /disconnect  - <code>ᴅɪsᴄᴏɴɴᴇᴄᴛ ғʀᴏᴍ ᴀ ᴄʜᴀᴛ</code>
➣ /connections - <code>ʟɪsᴛ ᴀʟʟ ʏᴏᴜʀ ᴄᴏɴɴᴇᴄᴛɪᴏɴs</code>"""
    EXTRAMOD_TXT = """Help: <b>🛠 ༒Extra Modules༒ 🛠</b>

<b>📌 ༒NOTE༒:</b>
☞ ᴛʜᴇsᴇ ᴀʀᴇ ᴛʜᴇ ᴇxᴛʀᴀ ғᴇᴀᴛᴜʀᴇs ᴏғ Gʟɪᴛᴄʜs Pʀᴏ Bᴏᴛ ⚡
...
<b>༒Commands and Usage༒:</b>
➣ /logs - <code>Tᴏ ɢᴇᴛ ᴛʜᴇ ʀᴇsᴄᴇɴᴛ ᴇʀʀᴏʀS</code>
...
➣ /broadcast - <code>ᴛᴏ ʙʀᴏᴀᴅᴄᴀsᴛ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs⇶</code>"""
    STATUS_TXT = """★ Tᴏᴛᴀʟ FFɪʟᴇs ✧ 📂 : <code>{}</code>
★ Tᴏᴛᴀʟ Usᴇʀ's ✧ 👩‍💻 : <code>{}</code>
★ Tᴏᴛᴀʟ Cʜᴀᴛs  ✧ 🔰 : <code>{}</code>
★ Usᴇᴅ Sᴛᴏʀᴀɢᴇ✧:<code>{}</code> M1B
★ Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ✧:<code>{}</code> M1B"""
    LOG_TEXT_G = """#NewGroup
Group = {}(<code>{}</code>)
